        ...
        <form onSubmit={submitHandler} className='w-1/2 border border-gray-400 rounded-md p-4 my-10'>
          ...
          <div>
            ...
            <Input type={"email"} name="email" value={input.email}
              onChange={changeEventHandler} placeholder="prateekbanwari0@gmail.com" />
          </div>
          <div>
          ...
          {
            loading ? <Button className='w-full my-4'><Loader2 className='w-full animate-spin' />Please wait</Button> : <Button type="submit" className='w-full my-4 cursor-pointer bg-gray-800 text-white'>Login</Button>
          }
